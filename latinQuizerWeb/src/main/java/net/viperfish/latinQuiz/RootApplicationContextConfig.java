...
public class RootApplicationContextConfig implements AsyncConfigurer, SchedulingConfigurer,
	...
	@Bean
	public DataSource latinQuizDataSource() {
		JndiDataSourceLookup lookup = new JndiDataSourceLookup();
		return lookup.getDataSource("jdbc/latinQuiz");
	}
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactoryBean() {
		...
		factory.setDataSource(this.latinQuizDataSource());
		factory.setPackagesToScan("net.viperfish.latinQuiz");
