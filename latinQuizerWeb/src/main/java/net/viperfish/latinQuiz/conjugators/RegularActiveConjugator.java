...
abstract class RegularActiveConjugator implements Conjugator {
	...
	public ConjugatedVerb[][] conjugate(Tense t, String first, String second, String third, String fourth) {
		...
		if (t == Tense.PRESENT) {
			result[0][0] = new ConjugatedVerb(first, Arrays.asList(new MutableTriple<String, List<String>, String>(
					SpecialI18NCodes.REGULAR_ACTIVE_PRESENT_FIRST_SING, new LinkedList<String>(), first)));
		}
		return result;
	}
