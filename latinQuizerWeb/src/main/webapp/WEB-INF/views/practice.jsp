                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="checkbox checkbox_left_margin">
                                            <label> <form:checkbox path="conjugations" value="2"/>
                                                <spring:message
                                                        code="practice.secondConj"></spring:message>
                                            </label>
                                        </div>
                                        ...
                                        <div class="checkbox checkbox_left_margin">
                                            <label> <form:checkbox path="conjugations" value="3"/>
                                                <spring:message
                                                        code="practice.thirdOConj"></spring:message>
                                            </label>
                                        </div>
                                        ...
                                        <div class="checkbox checkbox_left_margin">
                                            <label> <form:checkbox path="conjugations" value="5"/>
                                                <spring:message
                                                        code="practice.thirdIOConj"></spring:message>
                                            </label>
                                        </div>
                                        ...
                                        <div class="checkbox checkbox_left_margin">
                                            <label> <form:checkbox path="conjugations" value="4"/>
                                                <spring:message
                                                        code="practice.fourthConj"></spring:message>
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <h4 class="panel-title">
                                    <a data-toggle="collapse" data-parent="#accordion"
                                       href="#collapse2"> <spring:message
                                            code="practice.tense"></spring:message></a>
                                </h4>
                            </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="checkbox checkbox_left_margin">
                                            <label> <form:checkbox path="tenses"
                                                                   value="IMPERFECT"/>
                                                <spring:message code="IMPERFECT"></spring:message>
                                            </label>
                                        </div>
                                        ...
                                        <div class="checkbox checkbox_left_margin">
                                            <label> <form:checkbox path="tenses"
                                                                   value="PLUPERFECT"/>
                                                <spring:message code="PLUPERFECT"></spring:message>
                                            </label>
                                        </div>
                                    </div>
                                ...
                                <h4 class="panel-title">
                                    <a data-toggle="collapse" data-parent="#accordion"
                                       href="#collapse3"> <spring:message
                                            code="practice.mood"></spring:message></a>
                                </h4>
                            </div>
                                ...
                                <h4 class="panel-title">
                                    <a data-toggle="collapse" data-parent="#accordion"
                                       href="#collapse4"> <spring:message
                                            code="practice.voice"></spring:message></a>
                                </h4>
                            </div>
                                ...
                                <h4 class="panel-title">
                                    <a data-toggle="collapse" data-parent="#accordion"
                                       href="#collapse5"> <spring:message
                                            code="practice.type"></spring:message></a>
                                </h4>
                            </div>
                    ...
                    <div class="panel-group" id="accordionNoun">
                            ...
                            <div class="panel-heading">
                                <h4 class="panel-title">
                                    <a data-toggle="collapse" data-parent="#accordionNoun"
                                       href="#noun1"> <spring:message
                                            code="practice.declension"></spring:message></a>
                                </h4>
                            </div>
                                    ...
                                    <div class="form-group">
                                        <div class="checkbox checkbox_left_margin">
                                            <label> <form:checkbox path="declensions" value="0"/>
                                                <spring:message
                                                        code="practice.firstDec"></spring:message>
                                            </label>
                                        </div>
                                        <div class="checkbox checkbox_left_margin">
                                            <label> <form:checkbox path="declensions" value="1"/>
                                                <spring:message
                                                        code="practice.secondDec"></spring:message>
                                            </label>
                                        </div>
                                        <div class="checkbox checkbox_left_margin">
                                            <label> <form:checkbox path="declensions" value="2"/>
                                                <spring:message
                                                        code="practice.thirdDec"></spring:message>
                                            </label>
                                        </div>
                                        <div class="checkbox checkbox_left_margin">
                                            <label> <form:checkbox path="declensions" value="3"/>
                                                <spring:message
                                                        code="practice.fourthDec"></spring:message>
                                            </label>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h4 class="panel-title">
                                    <a data-toggle="collapse" data-parent="#accordionNoun"
                                       href="#noun2"> <spring:message
                                            code="practice.gender"></spring:message></a>
                                </h4>
                            </div>
